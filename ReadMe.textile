...
The first thing you wil notice is the inclusion of the SISimon.h header file. A necessary evil unfortunately. The second thing you will notice is the <pre>SIMapStepToSelector(@"Given Simon is working", simonIsRunning)</pre> line. That's Simon. This preprocessor directive instructs Simon to map the given step to the selector. 
